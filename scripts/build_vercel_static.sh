...
for required in solucoes/workforce/index.html assets/css/workforce.css assets/css/home-commercial.css assets/img/predixai-workforce-flow.svg assets/img/social-card.svg;do [[ -f "${DIST_DIR}/${required}" ]]||fail "entrega Workforce ausente: ${required}";done
